    ...
    <div class="productos-content-wrapper">
        ...
        <div class="producto-item">
            ...
            <div class="producto-info">
                ...
                <a href="{{ route('download.datasheet', 'PITTED PRUNES.pdf') }}" class="btn-download-datasheet">
        ...
        <div class="producto-item">
            ...
            <div class="producto-info">
                ...
                <a href="{{ route('download.datasheet', 'PRUNES WITH PÍTS.pdf') }}" class="btn-download-datasheet">
                    <i class="fas fa-file-pdf"></i> {{ __('messages.download_datasheet') }}
                </a>
            </div>
        </div>
        <div class="producto-item">
            ...
            <div class="producto-info">
                ...
                <a href="{{ route('download.datasheet', 'PRUNES21.pdf') }}" class="btn-download-datasheet">
                    <i class="fas fa-file-pdf"></i> {{ __('messages.download_datasheet') }}
                </a>
            </div>
        </div>
        <div class="producto-item">
            ...
            <div class="producto-info">
                ...
                <a href="{{ route('download.datasheet', 'DEHYDRATED PRUNES PULP.pdf') }}" class="btn-download-datasheet">
                    <i class="fas fa-file-pdf"></i> {{ __('messages.download_datasheet') }}
                </a>
            </div>
        </div>
        <div class="producto-item">
            ...
            <div class="producto-info">
                ...
                <a href="{{ route('download.datasheet', 'CONCENTRATED PRUNES JUICE 36 meses de duración.pdf') }}" class="btn-download-datasheet">
                    <i class="fas fa-file-pdf"></i> {{ __('messages.download_datasheet') }}
                </a>
            </div>
        </div>
